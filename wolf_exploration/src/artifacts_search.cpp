...
{
public:
  ArtifactsSearch() : converter_loader_("costmap_converter", "costmap_converter::BaseCostmapToPolygons"), n_("~")
  {
...
{
  ros::init(argc, argv, "artifacts_search");

  ArtifactsSearch search;
